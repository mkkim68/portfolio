  ...
  return (
    <div className="w-full flex flex-col gap-5">
      <div className="flex items-center justify-between">
        <div className="text-border text-sm">{t.game.hint}</div>
      </div>
          ...
          <div className="h-full flex flex-col items-start justify-between relative z-10">
            <div className="flex flex-col gap-3">
              ...
              <div className="text-border text-sm leading-6">
                {t.game.descriptionParts.before}
                <span className="text-highlight">
                  {t.game.descriptionParts.highlight}
                </span>
                {t.game.descriptionParts.after}
              </div>
            </div>
            <button
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <input
                    ...
                    placeholder={t.game.form.placeholder}
